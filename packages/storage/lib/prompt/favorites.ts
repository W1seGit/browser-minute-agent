...
const defaultFavoritePrompts = [
  ...
  },
  {
    ...
    content: 'Open the current page and summarize the most important actions available.',
  },
  {
    title: 'Find main action',
    content: 'Find the main call to action on the current page and explain what it does.',
  },
];
